...
class CNNandDinov2(nn.Module):
    def __init__(self, cnn_kwargs = None, amp = False, dinov2_weights = None, amp_dtype = torch.float16):
        ...
        self.dinov2_vitl14 = vit_large(**vit_kwargs).eval()
    ...
    def forward(self, x, upsample = False):
        ...
        if not upsample:
            with torch.no_grad():
                ...
                features_16 = dinov2_features_16['x_norm_patchtokens']
                features_16 = features_16.permute(0,2,1)
                features_16 = features_16.reshape(B, 1024, H//14, W//14)
