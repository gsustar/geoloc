...
> [!WARNING]
> This is a stripped down version of [OrthoLoC](https://github.com/deepscenario/OrthoLoC) repository. 

- Removed benchmarking, correspondaces, image_matching, scripts and assets directories
- Removed misc.py, metrics.py and plot.py from utils
- Adjusted OrthoLoC dataset code, to work with the given changes
___
