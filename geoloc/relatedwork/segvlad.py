...
for r_id, r_img in tqdm(enumerate(ims1_r), total=len(ims1_r), desc="Processing for reference images..."):
	...
	imInds1_ind, regInds1_ind, segMask1_ind = getIdxSingleFast(r_id,masks_seg,minArea=experiment_config['minArea'])
	...
	gd = seg_vlad_gpu_single(ind_matrix, idx_matrix, dino1_h5_r, r_img, segMask1_ind, c_centers, cfg, desc_dim=1536, adj_mat=adjMat1_ind)
