...
def video_to_trajectory(video_path, sampling_rate_frames=10, sampling_rate_seconds=None, center_crop=None, skip_first_n_samples=0):
	"""
	...
	assert os.path.exists(metadata_path), f"Metadata file does not exist: {metadata_path}"
...
if __name__ == "__main__":
	video_path = "/storage/datasets/AerialLoc/Drone2Sat/FRISat/trajectories/FRI-110m-sunny/FRI-110m-sunny.mp4"
	output_dir = "/storage/datasets/AerialLoc/Drone2Sat/FRISat/trajectories/FRI-110m-sunny/queries/"
	video_to_trajectory(video_path, output_dir, sampling_rate_seconds=10, center_crop=1024)
	print("all okay!")