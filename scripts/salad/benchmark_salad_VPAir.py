# CUDA_VISIBLE_DEVICES=0 PYTHONPATH=. DEBUG=2 python scripts/salad/benchmark_salad_VPAir.py --vdbdir /storage/datasets/AerialLoc/Drone2Sat/vdbs/salad/VPAir/paper_no_distractors --traj_config configs/salad/VPAir/benchmark_salad_VPAir.yaml
...
@torch.no_grad()
def benchmark_salad_vpair(vdbdir, traj_config):
...
def main():
	...
	benchmark_salad_vpair(args.vdbdir, traj_config)
