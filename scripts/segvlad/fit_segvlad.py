# CUDA_VISIBLE_DEVICES=1 DEBUG=0 PYTHONPATH=. python scripts/segvlad/fit_segvlad.py --config configs/anyloc/VPAir/fit_segvlad_VPAir.yaml --batchsize 16
...
@torch.no_grad()
def fit_segvlad(config, batchsize=16):
...
def main():
    ...
    fit_segvlad(config, batchsize=args.batchsize)
