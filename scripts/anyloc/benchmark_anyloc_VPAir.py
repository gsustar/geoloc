# CUDA_VISIBLE_DEVICES=0 PYTHONPATH=. DEBUG=2 python scripts/anyloc/benchmark_anyloc_VPAir.py --vdbdir /storage/datasets/AerialLoc/Drone2Sat/vdbs/anyloc/VPAir/paper --traj_config configs/anyloc/VPAir/benchmark_anyloc_VPAir.yaml
...
@torch.no_grad()
def benchmark_anyloc_vpair(vdbdir, traj_config):
    ...
    loaddir = fit_config.savedir  # savedir from fit_config is now loaddir
...
def main():
    ...
    benchmark_anyloc_vpair(args.vdbdir, traj_config)
